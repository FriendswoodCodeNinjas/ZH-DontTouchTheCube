...
public class PlayerControls : MonoBehaviour
{
    ...
    void Update()
    {
        //Rotating the game object on z axis multiplied the game frame rate by 7
        ...
        //Movement and rotation of the camera on the y axis horizontally
        rb.velocity += transform.rotation * (Vector3.right * Input.GetAxisRaw("Horizontal") * 10f * Time.deltaTime);
        //Movement and rotation of the camera on the y axis vertically
